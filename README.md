...
- `data/few_shot_examples.json` — эталонные примеры («запрос-ответ») для Few-Shot обучения LLM. Вы можете редактировать и добавлять туда правильные карточки и ответы модели.
